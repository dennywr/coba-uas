...
def loadData():
  ...
  data_url = st.text_input('Enter URL of your CSV file here', 'www.gantiurldatasetpunyasendiri.com')
...
def preprocessing():
  ...
  @st.cache_resource
  def load_data():
      data = pd.read_csv('www.gantiurldatasetpunyasendiri.com', index_col=False)
      return data
...
def preprocessingTanpaOutput():
  ...
  @st.cache_resource
  def load_data():
      data = pd.read_csv('www.gantiurldatasetpunyasendiri.com')
      return data
